...
class Automation:
    ...
    prompts = [
              ...
              "Press [3] to search directory",
              "Press [4] to create subdirectory:",
              "Press [1] to choose directory: "
              ]
    ...
    def createSubDirFile(self):
        ...
        self.fileName = os.path.join(self.root, self.subdirFile)
        print(self.fileName)
...
class Main(Automation):
    def showChoice(self):
        ...
        if self.cur_input == "1":
            ...
            self.showDelimter()
            self.curDirectoy = input(self.prompts[4]os.path.join(self.root, self.curDirectoy))
